...
VOX_DOWNLOADS = [
    (
        "http://thor.robots.ox.ac.uk/~vgg/data/voxceleb/vox1a/vox1_dev_wav_partaa",
        "e395d020928bc15670b570a21695ed96",
    ),
    (
        "http://thor.robots.ox.ac.uk/~vgg/data/voxceleb/vox1a/vox1_dev_wav_partab",
        "bbfaaccefab65d82b21903e81a8a8020",
    ),
    (
        "http://thor.robots.ox.ac.uk/~vgg/data/voxceleb/vox1a/vox1_dev_wav_partac",
        "017d579a2a96a077f40042ec33e51512",
    ),
    (
        "http://thor.robots.ox.ac.uk/~vgg/data/voxceleb/vox1a/vox1_dev_wav_partad",
        "7bb1e9f70fddc7a678fa998ea8b3ba19",
    ),
    (
        "http://thor.robots.ox.ac.uk/~vgg/data/voxceleb/vox1a/vox2_dev_aac_partaa",
        "da070494c573e5c0564b1d11c3b20577",
    ),
    (
        "http://thor.robots.ox.ac.uk/~vgg/data/voxceleb/vox1a/vox2_dev_aac_partab",
        "17fe6dab2b32b48abaf1676429cdd06f",
    ),
    (
        "http://thor.robots.ox.ac.uk/~vgg/data/voxceleb/vox1a/vox2_dev_aac_partac",
        "1de58e086c5edf63625af1cb6d831528",
    ),
    (
        "http://thor.robots.ox.ac.uk/~vgg/data/voxceleb/vox1a/vox2_dev_aac_partad",
        "5a043eb03e15c5a918ee6a52aad477f9",
    ),
    (
        "http://thor.robots.ox.ac.uk/~vgg/data/voxceleb/vox1a/vox2_dev_aac_partae",
        "cea401b624983e2d0b2a87fb5d59aa60",
    ),
    (
        "http://thor.robots.ox.ac.uk/~vgg/data/voxceleb/vox1a/vox2_dev_aac_partaf",
        "fc886d9ba90ab88e7880ee98effd6ae9",
    ),
    (
        "http://thor.robots.ox.ac.uk/~vgg/data/voxceleb/vox1a/vox2_dev_aac_partag",
        "d160ecc3f6ee3eed54d55349531cb42e",
    ),
    (
        "http://thor.robots.ox.ac.uk/~vgg/data/voxceleb/vox1a/vox2_dev_aac_partah",
        "6b84a81b9af72a9d9eecbb3b1f602e65",
    ),
    (
        "http://thor.robots.ox.ac.uk/~vgg/data/voxceleb/vox1a/vox1_test_wav.zip",
...
VOX_EXTRACT = ["vox1_dev_wav.zip", "vox1_test_wav.zip", "vox2_dev_aac.zip"]
...
def create_vox1_train_csv_gender(test_split=0.7):
    ...
    train_speakers = np.random.choice(
        all_speakers, size=int(test_split * len(all_speakers)), replace=False
    )
...
def create_vox2_train_csv_age():
    ...
    df_age_train = pd.read_csv(
        "https://raw.githubusercontent.com/nttcslab-sp/agevoxceleb/master/utt2age.train",
        sep=" ",
        names=["Key", "Age"],
    )
    df_age_test = pd.read_csv(
        "https://raw.githubusercontent.com/nttcslab-sp/agevoxceleb/master/utt2age.test",
        sep=" ",
        names=["Key", "Age"],
    )
